...
중요 규칙:
- RFP 원문에 직접 언급되지 않은 주제, 기술, 산업분야는 절대 포함하지 마세요.
- 참고자료에 있더라도 해당 사업과 무관한 내용(다른 산업의 사례, 다른 사업유형의 규정 등)은 제외하세요.
- [사업명], [발주기관] 같은 플레이스홀더를 사용하지 마세요. RFP에서 추출된 실제 사업명과 기관명을 사용하세요.
- 사업의 실제 목적, 범위, 과업 내용에 집중하여 작성하세요."""
